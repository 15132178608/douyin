...
class WindowsPackagingTests(unittest.TestCase):
    ...
    def test_control_script_exposes_local_operations_without_hidden_runtime_paths(self) -> None:
        ...
        self.assertIn('[ValidateSet("menu", "start", "stop", "status", "maintenance", "auth", "diagnose", "logs", "update", "health", "repair", "backup", "backups", "restore", "verify-backup")]', control)
    ...
    def test_windows_troubleshooting_doc_covers_installer_recovery(self) -> None:
        ...
        self.assertIn("uv run recall verify-backup", doc)
