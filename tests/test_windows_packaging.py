...
class WindowsPackagingTests(unittest.TestCase):
    ...
    def test_installed_qa_restores_inno_registration_after_isolated_install(self) -> None:
        ...
        self.assertIn("D:\\codexDownload\\douyin-release-v0.1.22\\DouyinRecallSetup.exe", script)
        self.assertIn("D:\\codexDownload\\douyin-release-v0.1.22\\installed-qa", script)
    ...
    def test_upgrade_qa_covers_real_installers_migration_reindex_and_uninstall(self) -> None:
        ...
        self.assertIn("D:\\codexDownload\\douyin-release-v0.1.22\\upgrade-qa", script)
        self.assertIn('"seed-legacy-search-db.py"', script)
        self.assertIn('Seed a populated legacy search schema', script)
        self.assertIn('"verify-v0.1.22-upgrade.py"', script)
        self.assertIn('"old_version": "0.1.21"', script)
        self.assertIn('"new_version": "0.1.22"', script)
        self.assertIn('-Label "v0.1.21"', script)
        self.assertIn('-Label "v0.1.22 in-place upgrade"', script)
        self.assertIn("version = \"0.1.22\"", script)
