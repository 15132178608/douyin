...
[Run]
Filename: "{sys}\wscript.exe"; Parameters: """{app}\packaging\windows\launch-douyin-recall.vbs"""; Description: "安装完成后启动 Douyin Recall"; Flags: postinstall unchecked nowait runhidden skipifsilent
